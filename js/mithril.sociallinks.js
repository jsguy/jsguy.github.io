...
var networks = {
		"facebook": {
			icon: function(size) {
				return [
					'<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="'+size+'px" height="'+size+'px" viewBox="0 0 266.893 266.895" enable-background="new 0 0 266.893 266.895" xml:space="preserve">',
		...
		"twitter": {
			icon: function(size) {
				return [
					'<svg xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300.00006 244.18703" height="'+(size*0.8125)+'px" width="'+size+'px" version="1.1" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">',
		...
		"googleplus": {
			icon: function(size) {
				return [
					'<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="'+size+'px" height="'+(size*0.96875)+'px" viewBox="0 0 134.658 131.646" enable-background="new 0 0 134.658 131.646" xml:space="preserve">',
					'	<g>',
...
var SocialLinkComponent = function(network, url, size){
	size = size || 32;
	var soc = networks[network];
	return m('span', {className: 'share-link'},
		m('a', {
			title: "Share on " + soc.text,
			href: soc.url(url),
			target: "_blank"
		}, m.trust(soc.icon(size)))
	);
};
